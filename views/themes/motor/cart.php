<div class="hero-wrap hero-bread"
    style="background-image: url('<?=base_url().'views/themes/'.theme_active().'/';?>images/dashboard69.jpg');">
    <div class="container">
        ...
        <form action="<?=base_url('user/proses_order');?>" method="post" enctype="multipart/form-data">
            <div class="row justify-content-end">
                ...
                <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                    ...
                    <?php else:?>
                    <p>Anda harus login terlebih dahulu untuk melakukan checkout pembayaran secara virtual Silahkan <a
                            href="<?=base_url('auth');?>"><b>Klik disini</b></a> Untuk Login System atau <a
                            href="https://wa.link/tc64w8"><b>Klik disini</a></b> Apabila ingin melakukan transaksi manual</p>
                    <?php endif;?>
