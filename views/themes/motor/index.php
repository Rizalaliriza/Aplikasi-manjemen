...
<body class="goto-here">
                    ...
                    <div class="row d-flex">
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            ...
                            <a href="tel:<?=settings('company_profile','phone');?>"><span
                                    class="text">082328325973</span></a>
                        </div>
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center"><span
                                    class="icon-paper-plane"></span></div>
                            <a href="mailto:<?=settings('company_profile','email');?>"><span
                                    class="text">satriaenergi.webmail.id</span></a>
                        </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="#">PT Satria Energi</a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item <?=isset($publicproduct) ? 'active':'';?>"><a
                            href="<?=base_url('public/product');?>" class="nav-link">Product Kami</a></li>
                    <li class="nav-item <?=isset($publiccategory) ? 'active':'';?>"><a
                            href="<?=base_url('public/category');?>" class="nav-link">Kategori Kami</a></li>
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2"><a href="#">PT Satria Energi</a></h2>
                        <p>Produk resmi dan bergaransi dari PT Satria Energi</p>
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span
                                        class="text">Jl. Mashuri Gg. Semangka No.7, Kalibogor, Rejasari, Kec. Purwokerto Bar., Kabupaten Banyumas<br>                                        
                                        Kode Pos
                                        53134</span></li>

                                <li><a href="tel:<?=settings('company_profile','phone');?>"><span
                                            class="icon icon-phone"></span><span
                                            class="text">08232832593</span></a></li>
                                <li><a href="mailto:<?=settings('company_profile','email');?>"><span
                                            class="icon icon-envelope"></span><span
                                            class="text">satriaenergi.webmail.id</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row" style="margin-bottom:-65px;">
                <div class="col-md-12 text-center">
                    ...
                    <p>
                        ...
                        Copyright &copy; <?=date('Y');?> All rights reserved PT. Satria Energi
