...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?=base_url().'uploads/panel24.jpg'; ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">PT. Satria Energi</h1>
            <h2 class="subheading mb-4">Kualitas Terbaik</h2>
    ...
    <div class="slider-item" style="background-image: url(<?=base_url().'uploads/panel25.jpg'; ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Barang dengan kualitas terbaik</h1>
            <h2 class="subheading mb-4">PT Satria Energi</h2>
            <p><a href="#products" class="btn btn-danger">Belanja Sekarang</a></p>
          </div>
        </div>
      </div>
    </div>
    <div class="slider-item" style="background-image: url(<?=base_url().'uploads/panel27.jpg'; ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          <div class="col-sm-12 ftco-animate text-center">
                ...
                <div class="row">
                    <div class="col-md-4 align-items-stretch d-flex">
                        <div class="category-wrap-2 ftco-animate img align-self-stretch d-flex"
                            style="background-image: url(<?=base_url().'views/themes/'.theme_active().'/';?>images/pixel22.jpg);">
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate text-center">
                ...
                <p>Berikut ini testimoni pelanggan yang sudah berlangganan diPerusahaan resmi kami.</p>
            </div>
        </div>
