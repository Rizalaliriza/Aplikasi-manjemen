<div class="hero-wrap hero-bread"
    style="background-image: url('<?=base_url().'views/themes/'.theme_active().'/';?>images/panel19.jpg');">
    <div class="container">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center"
                style="background-image: url(<?=base_url().'views/themes/'.theme_active().'/';?>images/panel23.jpg);">
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">Welcome to PT Satria Energi</h2>
                    </div>
                </div>
                <div class="pb-md-5">
                    <p>Silahkan berbelanja di website resmi PT. Satria Energi.</p>
                    <p>Perusahaan yang bergerak dibidang energi.</p>
                    <p><a href="<?=base_url('public/product');?>" class="btn btn-primary">Beli Sekarang</a></p>
                </div>
            </div>
        </div>
    </div>
...
<section class="ftco-section ftco-counter img" id="section-counter"
    style="background-image: url(<?=base_url().'views/themes/'.theme_active().'/';?>images/panel24.jpg);">
    <div class="container">
            ...
            <div class="col-lg-3 text-center d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services mb-md-0 mb-4">
                    ...
                    <div class="media-body">
                        <h3 class="heading">Silahkan Belanja</h3>
            ...
            <div class="col-lg-3 text-center d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services mb-md-0 mb-4">
                    ...
                    <div class="media-body">
                        ...
                        <span>Support dari tim ahli</span>
                    </div>
                </div>
            </div>
        </div>
