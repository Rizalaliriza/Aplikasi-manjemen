...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url(); ?>"><b>PT. Satria Energi</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Masukan Username & Paswword !</p>
            ...
            Sudah punya akun ?<a href="<?=base_url('auth');?>" class="text-center"> Login Sekarang</a>
            <br>
            <a href="<?=base_url();?>">Kemali ke website</a><br>
